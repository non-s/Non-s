...
const requiredFiles = [
  ...
  "scripts/check-nons-production.js",
...
if (exists(".github/workflows/quality.yml")) {
  ...
  for (const token of ["check-workflows.js", "validate-firebase-config.js", "check-nons-production.js", "check-html-assets.js", "check-repo-contracts.js"]) {
